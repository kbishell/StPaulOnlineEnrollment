...
CREATE TABLE OtherSchools_Student (studentID int NOT NULL,OtherSchoolsID int NOT NULL,CONSTRAINT OtherSchools_Students_pk PRIMARY KEY (studentID,OtherSchoolsID));
-- Table: Registration
