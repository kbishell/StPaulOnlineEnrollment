...
i
        <div class="panel-group" id="accordion">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <a data-toggle="collapse" data-parent="#accordion" href="#collapse1">Apply For Half-Day 3K</a>
                    </h4>
                </div>
                ...
                <div id="collapse1" class="panel-collapse collapse in">
                    <div class="panel-body">
                        ...
                        <form action="/pre3k" method="get">
                            <h3><strong>Half-Day 3K (7:30am - 11:00am)</strong></h3>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <a data-toggle="collapse" data-parent="#accordion" href="#collapse2">Apply For Half-Day 3K</a>
                    </h4>
                </div>
                <div id="collapse2" class="panel-collapse collapse">
                    <div class="panel-body">
                        ...
                        <form action="/pre4k" method="get">
                            <h3><strong>Half-Day 4K(7:30am - 11:00am)</strong></h3>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <a data-toggle="collapse" data-parent="#accordion" href="#collapse3">Apply For Full-Day 4K&3K</a>
                    </h4>
                </div>
                <div id="collapse3" class="panel-collapse collapse">
                    <div class="panel-body">
                        ...
                        <form action="/full" method="get">
                            <h3><strong>Full-Day 4K&3K -- Mixed Ages(7:30am - 3:00pm)</strong></h3>
